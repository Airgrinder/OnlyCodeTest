...
function updateContent(target: string) {
    ...
    let firstYear = document.getElementsByClassName("main-circle-years-first")[0] as HTMLElement;
    let lastYear = document.getElementsByClassName("main-circle-years-last")[0] as HTMLElement;
